...
const Questions = {
  ...
  catalogue: [
    ...
    { column: "Z", title: "Задачи 2", type: "rating5", group: "Работа", subgroup: "Нагрузка", report: true, filter: true, average: true, display: "Распределение", compare: true, answers: "1, 2, 3, 4, 5" },
    { column: "AA", title: "ЗП", type: "rating5", group: "Вознаграждение", subgroup: "Компенсация", report: true, filter: true, average: true, display: "Распределение", compare: true, answers: "1, 2, 3, 4, 6" },
